...
main: examples/main/main.cpp $(SRC_COMMON) ggml.o $(WHISPER_OBJ) fred.hpp
	$(CXX) $(CXXFLAGS) examples/main/main.cpp $(SRC_COMMON) ggml.o $(WHISPER_OBJ) -Ifred.hpp -o main $(LDFLAGS)
	./main -h
